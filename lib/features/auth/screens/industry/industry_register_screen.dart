...
class IndustryRegisterScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<IndustryRegisterScreen> createState() =>
      _IndustryRegisterScreenState();
}

class _IndustryRegisterScreenState extends ConsumerState<IndustryRegisterScreen> {
  ...
  void submit() async {
    if (_formKey.currentState!.validate()) {
      ...
      final inputs = IndustryRegisterInputs(
      ...
      ref.read(registerInputProvider.notifier).setIndustryRegisterInputs(inputs);
